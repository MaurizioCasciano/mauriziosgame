...
public class AudioPlaylist_JavaFX extends Application {
	private static final String MUSIC_DIR = "A:/_WORKSPACE_JAVA/JAVA_UNIVERSITA'/__Maurizio's   Game/res/music";
	...
	public void start(final Stage stage) throws Exception {
		stage.setTitle("Maurizio's Audio Player");

		// determine the source directory for the playlist
		// (either the first argument to the program or a default).
		...
		// Comment next line to hide player frame
		stage.show();
	}
